...
public class MobileAuthenticate {
    ...
    public String query(){
        //return "<SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:tns=\"http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:d=\"http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl\" xmlns:mss=\"http://www.sk.ee:8098/MSSP_GW/MSSP_GW.wsdl\" xmlns:SOAP=\"http://schemas.xmlsoap.org/wsdl/soap/\" xmlns:MIME=\"http://schemas.xmlsoap.org/wsdl/mime/\" xmlns:DIME=\"http://schemas.xmlsoap.org/ws/2002/04/dime/wsdl/\" xmlns:WSDL=\"http://schemas.xmlsoap.org/wsdl/\" xmlns:SOAP-ENC=\"http://schemas.xmlsoap.org/soap/encoding/\"><SOAP-ENV:Body><mns:MobileAuthenticate xmlns:mns=\"http://www.sk.ee/DigiDocService/DigiDocService_2_3.wsdl\" SOAP-ENV:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\"><IDCode xsi:type=\"xsd:string\">14212128025</IDCode><CountryCode xsi:type=\"xsd:string\">EE</CountryCode><PhoneNo xsi:type=\"xsd:string\">+37200007</PhoneNo><Language xsi:type=\"xsd:string\">EST</Language><ServiceName xsi:type=\"xsd:string\">Testimine</ServiceName><MessageToDisplay xsi:type=\"xsd:string\">Message!</MessageToDisplay><SPChallenge xsi:type=\"xsd:string\"></SPChallenge><MessagingMode xsi:type=\"xsd:string\">asynchClientServer</MessagingMode><AsyncConfiguration xsi:type=\"xsd:int\"></AsyncConfiguration><ReturnCertData xsi:type=\"xsd:boolean\"></ReturnCertData><ReturnRevocationData xsi:type=\"xsd:boolean\"></ReturnRevocationData></mns:MobileAuthenticate></SOAP-ENV:Body></SOAP-ENV:Envelope>";
